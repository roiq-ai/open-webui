...
from open_webui.migrations.util import get_existing_columns
...
def upgrade():
    ...
    existing_columns = get_existing_columns("file")
    if "hash" in existing_columns:
        print("Column 'hash' already exists in 'file' table")
    else:
        op.add_column("file", sa.Column("hash", sa.Text(), nullable=True))
    if "data" in existing_columns:
        print("Column 'data' already exists in 'file' table")
    else:
        op.add_column("file", sa.Column("data", sa.JSON(), nullable=True))
    if "updated_at" in existing_columns:
        print("Column 'updated_at' already exists in 'file' table")
    else:
