...
async def get_function_module(pipe_id: str):
...
async def get_pipe_models():
    ...
    for pipe in pipes:
        function_module = await get_function_module(pipe.id)
...
async def get_function_params(function_module, form_data, user, extra_params={}):
...
async def generate_function_chat_completion(form_data, user):
    ...
    tools = await get_tools(app, tool_ids, user, tools_params)
    ...
    pipe_id = get_pipe_id(form_data)
    function_module = await get_function_module(pipe_id)
